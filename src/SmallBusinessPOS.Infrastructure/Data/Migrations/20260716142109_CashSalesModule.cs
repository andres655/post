...
{
    /// <inheritdoc />
    public partial class CashSalesModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CashRegisters_Businesses_BusinessId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeclaredClosingBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CashSessions_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaleNumberSequences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaleNumberSequences_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleNumberSequences_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleNumberSequences_CashRegisters_CashRegisterId",
                        column: x => x.CashRegisterId,
                        principalTable: "CashRegisters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CashMovements_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashMovements_BusinessId",
                table: "CashMovements",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_CashMovements_CashSessionId_CreatedAtUtc",
                table: "CashMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashRegisters_BusinessId",
                table: "CashRegisters",
                column: "BusinessId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashSessions_BusinessId",
                table: "CashSessions",
                column: "BusinessId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutboxMessages_BusinessId_ProcessedAtUtc",
                table: "OutboxMessages",
                columns: new[] { "BusinessId", "ProcessedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutboxMessages_EventType_AggregateId",
                table: "OutboxMessages",
                columns: new[] { "EventType", "AggregateId" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_BusinessId_Code",
                table: "PaymentMethods",
                columns: new[] { "BusinessId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_BusinessId_IsActive",
                table: "PaymentMethods",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleNumberSequences_BranchId",
                table: "SaleNumberSequences",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleNumberSequences_BusinessId",
                table: "SaleNumberSequences",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleNumberSequences_CashRegisterId_BusinessDate",
                table: "SaleNumberSequences",
                columns: new[] { "CashRegisterId", "BusinessDate" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_BranchId_SoldAtUtc",
                table: "Sales",
                columns: new[] { "BranchId", "SoldAtUtc" });
